...
import img1 from '../../../assets/img/projetos/apt02/01.jpg'
import img2 from '../../../assets/img/projetos/apt02/02.jpg'
import img3 from '../../../assets/img/projetos/apt02/03.jpg'
import img4 from '../../../assets/img/projetos/apt02/04.jpg'
import img5 from '../../../assets/img/projetos/apt02/05.jpg'
import img6 from '../../../assets/img/projetos/apt02/06.jpg'
import img7 from '../../../assets/img/projetos/apt02/07.jpg'
import img8 from '../../../assets/img/projetos/apt02/08.jpg'
import img9 from '../../../assets/img/projetos/apt02/09.jpg'
import img10 from '../../../assets/img/projetos/apt02/10.jpg'
import Regiao from '../../../assets/img/projetos/apt02/regiao.jpg'
import Pdf from '../../../assets/pdf/02.pdf'
        ...
        >
            ...
            <section className={styles.apDescritivo}>
                <div className={styles.boxInfo}>
                    ...
                    <a
                        href='https://wa.me//5511982344334?text=https://lealmeular.com.br/projetos/ap02%0AOlá%20tudo%20bem?%0ATenho%20interesse%20nesse%20empreendimento' target='_blank'
                        rel="noreferrer"
                        id={styles.whatsApp}
                    >
                ...
                <div className={styles.apContainer}>
                    <div className={styles.apTitle}>
                        ...
                        <div className={styles.apParagrafo}>
                            <p>
                                Apartamentos à venda no bairro do Limão com 2 dormitórios, opção de vaga, suíte, vaga e lazer surpreendente. Conheça o Dez Limão com a Cury!
                            </p>
                            <p>
                                Próximo ao Bourbon Shopping, Leroy Merlin e Assaí Atacadista;
                                Fácil acesso à Marginal Tietê e Av. Engenheiro Caetano Álvares;
                                Próximo à Estação Água Branca e ao Terminal Barra Funda
                            </p>
                            <p>
                                Compre na planta com preço imperdível.
                                Fale com um corretor online e faça uma simulação de financiamento!
                            </p>
                        </div>
                    </div>
                </div>
