...
import img1 from '../../../assets/img/projetos/apt03/01.jpg'
import img2 from '../../../assets/img/projetos/apt03/02.jpg'
import img3 from '../../../assets/img/projetos/apt03/03.jpg'
import img4 from '../../../assets/img/projetos/apt03/04.jpg'
import img5 from '../../../assets/img/projetos/apt03/05.jpg'
import img6 from '../../../assets/img/projetos/apt03/06.jpg'
import img7 from '../../../assets/img/projetos/apt03/07.jpg'
import img8 from '../../../assets/img/projetos/apt03/08.jpg'
import img9 from '../../../assets/img/projetos/apt03/09.jpg'
import img10 from '../../../assets/img/projetos/apt03/10.jpg'
import Regiao from '../../../assets/img/projetos/apt03/regiao.jpg'
import Pdf from '../../../assets/pdf/03.pdf'
...
function Apt03() {
    ...
    return (
        ...
        >
            <Header
                banner='BannerAp03'
                title='Guido Parque Nações Unidas'
            ...
            <section className={styles.apDescritivo}>
                <div className={styles.boxInfo}>
                    ...
                    <a
                        href='https://wa.me//5511982344334?text=https://lealmeular.com.br/projetos/ap03%0AOlá%20tudo%20bem?%0ATenho%20interesse%20nesse%20empreendimento' target='_blank'
                        rel="noreferrer"
                        id={styles.whatsApp}
                    >
                ...
                <div className={styles.apContainer}>
                    <div className={styles.apTitle}>
                        ...
                        <div className={styles.apParagrafo}>
                            <p>
                                Apartamentos à venda em Santo Amaro com 2 dormitórios, opção de terraço e um lazer incrível. Conheça o Guido Parque Nações Unidas com a Cury!
                            </p>
                            <p>
                                Fácil acesso ao terminal Guido Caloi e à estação Santo Amaro;
                                Próximo ao Shopping Fiesta, Poupatempo e Assaí Atacadista;
                                Lazer completo do jeito que você merece!
                            </p>
                            <p>
