...
import img1 from '../../../assets/img/projetos/apt08/01.jpeg'
import img2 from '../../../assets/img/projetos/apt08/02.jpg'
import img3 from '../../../assets/img/projetos/apt08/03.jpg'
import img4 from '../../../assets/img/projetos/apt08/04.jpg'
import img5 from '../../../assets/img/projetos/apt08/05.jpg'
import img6 from '../../../assets/img/projetos/apt08/06.jpg'
import img7 from '../../../assets/img/projetos/apt08/07.jpg'
import img8 from '../../../assets/img/projetos/apt08/08.jpg'
import img9 from '../../../assets/img/projetos/apt08/09.jpg'
import img10 from '../../../assets/img/projetos/apt08/10.jpg'
import Regiao from '../../../assets/img/projetos/apt08/regiao.jpg'
import Pdf from '../../../assets/pdf/08.pdf'
        ...
        >
            ...
            <section className={styles.apDescritivo}>
                <div className={styles.boxInfo}>
                    ...
                    <a
                        href='https://wa.me//5511982344334?text=https://lealmeular.com.br/projetos/ap08%0AOlá%20tudo%20bem?%0ATenho%20interesse%20nesse%20empreendimento' target='_blank'
                        rel="noreferrer"
                        id={styles.whatsApp}
                    >
                ...
                <div className={styles.apContainer}>
                    <div className={styles.apTitle}>
                        ...
                        <div className={styles.apParagrafo}>
                            <p>
                                Apartamentos à venda na Barra Funda com 2 dormitórios, opção de suíte e terraço e lazer completo. Conheça o The Place Barra Funda com a Cury!
                            </p>
                            <p>
                                Ao lado da Marginal Tietê;
                                Próximo ao Terminal Palmeiras-Barra Funda;
                                Fácil acesso ao Allianz Parque e ao Shopping Bourbon
                            </p>
                            <p>
