...
import img1 from '../../../assets/img/projetos/apt04/01.jpg'
import img2 from '../../../assets/img/projetos/apt04/02.jpg'
import img3 from '../../../assets/img/projetos/apt04/03.jpg'
import img4 from '../../../assets/img/projetos/apt04/04.jpg'
import img5 from '../../../assets/img/projetos/apt04/05.jpg'
import img6 from '../../../assets/img/projetos/apt04/06.jpg'
import img7 from '../../../assets/img/projetos/apt04/07.jpg'
import img8 from '../../../assets/img/projetos/apt04/08.jpg'
import img9 from '../../../assets/img/projetos/apt04/09.jpg'
import img10 from '../../../assets/img/projetos/apt04/10.jpg'
import Regiao from '../../../assets/img/projetos/apt04/regiao.jpg'
import Pdf from '../../../assets/pdf/04.pdf'
        ...
        >
            ...
            <section className={styles.apDescritivo}>
                <div className={styles.boxInfo}>
                    ...
                    <a
                        href='https://wa.me//5511982344334?text=https://lealmeular.com.br/projetos/ap04%0AOlá%20tudo%20bem?%0ATenho%20interesse%20nesse%20empreendimento' target='_blank'
                        rel="noreferrer"
                        id={styles.whatsApp}
                    >
                ...
                <div className={styles.apContainer}>
                    <div className={styles.apTitle}>
                        ...
                        <div className={styles.apParagrafo}>
                            <p>
                                Apartamentos à venda na Zona Sul de São Paulo com 2 dorms., opção de vaga e lazer surpreendente. Conheça o Guedala Park com a Cury Construtora!
                            </p>
                            <p>
                                Ao lado do Parque Linear Caxingui
                                Próximo à estação São Paulo Morumbi
                                Em frente à Avenida Francisco Morato
                            </p>
                            <p>
                                Compre na planta com preço imperdível.
                                300 unidades HMP e 198 unidades R2V, ambas com condições atrativas de financiamento.
                                Fale com um corretor online agora mesmo e faça uma simulação!
                            </p>
                        </div>
                    </div>
                </div>
